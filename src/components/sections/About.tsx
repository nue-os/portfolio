...
const skills = [
  { category: 'Language', items: ['JavaScript', 'TypeScript', 'Java', 'Python'] },
  { category: 'Frontend', items: ['React.js', 'Next.js', 'HTML5', 'CSS3'] },
  { category: 'Styling', items: ['Styled-component', 'SCSS', 'TailwindCSS'] },
  { category: 'State Management', items: ['Recoil', 'Zustand', 'Tanstack Query'] },
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="flex justify-center">
              <div className="relative w-64 h-64 md:w-72 md:h-72">
                ...
                />
                <div hidden className="absolute inset-0 flex flex-col items-center justify-center gap-3 text-violet-700/50 rounded-2xl">
